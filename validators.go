...
func newVal() val {
	return val{
		NotEmpty: func(candidate interface{}, params Params) bool {
		...
		Min: func(candidate interface{}, params Params) bool {
		...
		Between: func(candidate interface{}, params Params) bool {
			min := params.Get("min").(int)
		...
		Email: func(candidate interface{}, params Params) bool {
			switch candidate.(type) {
			case string:
